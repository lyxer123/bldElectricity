  ...
  <el-container id="device_manage"
    ...
    <el-main>
      ...
      <el-table :data="table_data"
        ...
        <el-table-column label="设备名称"
                         prop="chipId"></el-table-column>
        <el-table-column label="钱包地址"
                         prop="deviceWallet"
                         min-width="150"></el-table-column>
        <el-table-column label="钱包余额"
                         prop="deviceMoney"></el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button class="round_button"
                       @click="history_transfer(scope.row)"
                       title="查看历史转账记录">
              <svg-icon class="bld_icon"
    ...
    <el-drawer size="70%"
      ...
      <div class="assets_show_list">
        <el-table :data="show_table_data"
                  style="width: 100%">
          <el-table-column label="转账时间"
                           prop="addTime"></el-table-column>
          <el-table-column label="出款地址"
                           prop="fromWallet"
          ...
          <el-table-column label="txHash"
            ...
            <el-link :underline="false"
                     slot-scope="scope"
                     @click="show_block_info(scope.row.hash)">{{ scope.row.hash }}</el-link>
          </el-table-column>
        </el-table>
