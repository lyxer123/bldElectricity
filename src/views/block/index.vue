...
<el-container id="device_manage" v-loading="loading">
    ...
    <el-main>
        ...
        <el-pagination @size-change="search_block" @current-change="search_block" :current-page="search.pageNum" :page-sizes="[50, 100, 200, 300, 400]" :page-size="search.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="search.total">
        </el-pagination>
    </el-main>
