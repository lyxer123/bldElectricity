...
<el-container id="device_manage" v-loading="loading">
    ...
    <el-drawer size="70%" title="转账记录列表" custom-class="drawer_class" :direction="direction" :visible.sync="block_transfer_drawer">
        <div class="assets_show_list">
            ...
            <el-pagination @size-change="handleSizeChange2" @current-change="handleCurrentChange2" :current-page="search2.pageNum" :page-sizes="[10,20,50,100,200]" :page-size="search2.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="search2.total">
            </el-pagination>
        </div>
    </el-drawer>
